...
HTT:RegisterTitle("@gncwolf", nil, 92, {en = "Beşiktaş"}, {color={"#7A7A7A", "#E6E6E6"}})
HTT:RegisterTitle("@wulfy1987", nil, 92, {en = "Beşiktaş"}, {color={"#7A7A7A", "#E6E6E6"}})

-- test
-- HTT:RegisterTitle("@nogetrandom", nil, 92, {en = "Beşiktaş"}, {color={"#7A7A7A", "#E6E6E6"}})
