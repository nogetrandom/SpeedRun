		...
		for i = 1, MAX_BOSSES do
				...
				if DoesUnitExist("boss" .. i) then
						...
						if Speedrun.Step <= 6 then
								...
								if Speedrun.currentBossName == "Leptfire Keeper" or boss == "Xobutar of His Deep Graces" or boss == "Mynar Metron" then
...
Speedrun.OnTrialComplete = function(eventCode, trialName, score, totalTime)
	  ...
	  if Speedrun.raidID == 636 or Speedrun.raidID == 1000 or Speedrun.raidID == 1082 or Speedrun.raidID == 1227 then
				zo_callLater(function()
						Speedrun.UpdateWaypointNew(GetRaidDuration())
				end, 1000)
